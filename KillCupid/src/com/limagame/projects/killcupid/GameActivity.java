...
public class GameActivity extends SimpleBaseGameActivity {
	...
	protected void onCreateResources() {
		...
		this.mBitmapTextureAtlas = new BuildableBitmapTextureAtlas(this.getTextureManager(), 800, 480, TextureOptions.DEFAULT);
		this.mPlayerTiledTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBitmapTextureAtlas, this, "rotoman1.png", 1, 1);
		this.mPlayerTiledTextureRegionRotoman = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBitmapTextureAtlas, this, "rotoman2.png", 1, 1);
		this.mPlayerTiledTextureRegionCupid = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBitmapTextureAtlas, this, "cupid1.png", 1, 1);
		
		this.mPlayerTiledTextureRegionPonny = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBitmapTextureAtlas, this, "pony.png", 1, 1);
		this.mPlayerTiledTextureRegionRabbit = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBitmapTextureAtlas, this, "rabit2.png", 1, 1);
		this.mPlayerTiledTextureRegionBear = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBitmapTextureAtlas, this, "bear.png", 1, 1);
		
		//juanisimo2.png
		this.mPlayerTiledTextureRegionCupidBoss = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBitmapTextureAtlas, this, "juanisimo2.png", 1, 1);
		
		this.mPlayerTiledTextureRegionProjectile = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mBitmapTextureAtlas, this, "flecha120x150.png", 1, 1);
